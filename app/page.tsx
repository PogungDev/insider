      ...
      <div className="container mx-auto px-4 py-12">
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-8">
            Platform analisis mendalam untuk memahami perilaku wallet spesifik di Sei blockchain. 
            Monitor pola transaksi, deteksi anomali, dan dapatkan insights investasi dengan 
            teknologi AI dan machine learning real-time.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-8">
            <div className="bg-purple-50 p-6 rounded-lg border">
              <h3 className="font-semibold text-purple-800 mb-1">Wallet Intelligence Hub</h3>
              <p className="text-sm text-purple-700">Graph Explorer, Identity Profiler, dan Behavioral Clustering</p>
            </div>
            <div className="bg-blue-50 p-6 rounded-lg border">
              <h3 className="font-semibold text-blue-800 mb-1">Risk Radar System</h3>
              <p className="text-sm text-blue-700">Threat Monitor, Contract Auditor, dan Exploit Simulator</p>
            </div>
            <div className="bg-green-50 p-6 rounded-lg border">
              <h3 className="font-semibold text-green-800 mb-1">Behavioral DNA Analysis</h3>
              <p className="text-sm text-green-700">Habit Analyzer, Sentiment Decoder, dan Predictive Model</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {isConnecting ? "Connecting..." : "Mulai Analisis"}
        ...
        <section className="mb-16">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 border border-blue-200 mb-12">
            <h3 className="text-3xl font-bold mb-8 text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              🔄 Cara Kerja Wallet Behavior Analyst
            </h3>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="bg-white rounded-xl p-6 border border-blue-200 hover:border-blue-400 hover:shadow-lg transition-all">
                ...
                <p className="text-gray-600 text-sm">
                  Masukkan alamat wallet untuk analisis mendalam. Universal Search 
                  memungkinkan pencarian cepat dan akurat di seluruh blockchain.
                </p>
              ...
              <div className="bg-white rounded-xl p-6 border border-purple-200 hover:border-purple-400 hover:shadow-lg transition-all">
                ...
                <p className="text-gray-600 text-sm">
                  Visualisasi interaktif hubungan antar wallet dengan Graph Explorer. 
                  Identifikasi cluster dan pola koneksi yang tersembunyi.
                </p>
              ...
              <div className="bg-white rounded-xl p-6 border border-green-200 hover:border-green-400 hover:shadow-lg transition-all">
                ...
                <p className="text-gray-600 text-sm">
                  Habit Analyzer mengidentifikasi pola perilaku unik setiap wallet. 
                  Sentiment Decoder dan Predictive Model untuk insights mendalam.
                </p>
              ...
              <div className="bg-white rounded-xl p-6 border border-yellow-200 hover:border-yellow-400 hover:shadow-lg transition-all">
                ...
                <p className="text-gray-600 text-sm">
                  Threat Monitor untuk deteksi aktivitas mencurigakan. 
                  Multi-Layer Alerts memberikan peringatan real-time.
                </p>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200">
              <h4 className="text-xl font-semibold mb-4 text-center text-gray-800">Alur Analisis Wallet</h4>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-slate-50 rounded-2xl p-8 border border-gray-200 mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all">
                ...
                <div className="bg-gray-900 rounded-lg p-4 font-mono text-sm overflow-x-auto">
                  <div className="text-gray-400">// Analisis wallet secara instant</div>
                  ...
                  <br/>
                  <div className="text-gray-400">// Dapatkan behavior score real-time</div>
              ...
              <div className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all">
                ...
                <div className="bg-gray-900 rounded-lg p-4 font-mono text-sm overflow-x-auto">
                  <div className="text-gray-400">// Monitoring wallet real-time</div>
                  ...
                  <br/>
                  <div className="text-gray-400">// Subscribe ke alerts</div>
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              <div className="text-center p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-all">
                ...
                <div className="text-sm text-gray-600 mt-1">Analisis wallet instant via /analyze command</div>
              </div>
              <div className="text-center p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-all">
                <div className="text-2xl mb-2">🎮</div>
                <div className="font-semibold text-purple-700">Discord Integration</div>
                <div className="text-sm text-gray-600 mt-1">Community alerts dan whale movements</div>
              </div>
              <div className="text-center p-4 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-all">
                <div className="text-2xl mb-2">🔗</div>
                <div className="font-semibold text-green-700">Webhook Support</div>
                <div className="text-sm text-gray-600 mt-1">Custom integrations untuk platform apapun</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            <div className="bg-white p-6 rounded-lg border hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-gray-600">Graph Explorer untuk visualisasi network, Identity Profiler untuk analisis mendalam, Behavioral Clustering untuk pengelompokan pola, dan Annotated Timeline untuk tracking historis.</p>
            </div>
            <div className="bg-white p-6 rounded-lg border hover:shadow-lg transition-shadow">
              <div className="text-3xl mb-3">🛡️</div>
              <h4 className="font-semibold text-lg mb-2 text-red-800">Risk Radar System</h4>
              <p className="text-sm text-gray-600">Threat Monitor untuk deteksi real-time, Contract Auditor untuk analisis keamanan smart contract, Liquidity Scanner, dan Exploit Simulator untuk simulasi serangan.</p>
            </div>
            <div className="bg-white p-6 rounded-lg border hover:shadow-lg transition-shadow">
              <div className="text-3xl mb-3">💰</div>
              <h4 className="font-semibold text-lg mb-2 text-green-800">Capital Flow Nexus</h4>
              <p className="text-sm text-gray-600">Liquidity Radar untuk monitoring likuiditas, Flow Pattern Detector untuk analisis aliran dana, Smart Money Tracker, dan Cross-Chain Monitor untuk tracking lintas blockchain.</p>
            </div>
            <div className="bg-white p-6 rounded-lg border hover:shadow-lg transition-shadow">
              <div className="text-3xl mb-3">🧬</div>
              <h4 className="font-semibold text-lg mb-2 text-purple-800">Behavioral DNA</h4>
              <p className="text-sm text-gray-600">Habit Analyzer untuk analisis kebiasaan trading, Sentiment Decoder untuk analisis sentimen, Personality Profiler untuk profiling kepribadian trader, dan Predictive Model untuk prediksi perilaku.</p>
            </div>
            <div className="bg-white p-6 rounded-lg border hover:shadow-lg transition-shadow">
              <div className="text-3xl mb-3">🚀</div>
              <h4 className="font-semibold text-lg mb-2 text-indigo-800">Alpha Synthesis Engine</h4>
              <p className="text-sm text-gray-600">Strategy Backtester untuk testing strategi, Report Generator untuk laporan otomatis, Alpha Ranking untuk ranking peluang, dan AI Recommendations untuk rekomendasi investasi.</p>
            </div>
            <div className="bg-white p-6 rounded-lg border hover:shadow-lg transition-shadow">
              <div className="text-3xl mb-3">🔔</div>
              <h4 className="font-semibold text-lg mb-2 text-orange-800">Multi-Layer Alerts</h4>
              <p className="text-sm text-gray-600">Sistem peringatan berlapis dengan notifikasi real-time untuk aktivitas mencurigakan, perubahan pola perilaku, dan peluang investasi potensial.</p>
            </div>
          </div>
        </section>
