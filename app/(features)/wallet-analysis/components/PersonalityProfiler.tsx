...
const PersonalityProfiler: React.FC = () => {
  ...
  const loadPersonalityData = () => {
    let mockProfiles: PersonalityProfile[] = [];
    
    // Add target wallet profile if available
    if (targetWallet && analysisData) {
      const targetProfile: PersonalityProfile = {
        id: 'target',
        walletAddress: targetWallet,
        label: 'Target Wallet',
        personalityType: 'balanced',
        riskProfile: {
          riskTolerance: analysisData.riskLevel === 'high' ? 85 : analysisData.riskLevel === 'low' ? 35 : 60,
          riskCapacity: 70,
          lossAversion: 50,
          volatilityComfort: 60,
          leverageUsage: 40,
          diversificationLevel: 65,
          hedgingBehavior: 55,
        ...
        socialInfluence: {
          susceptibility: 45,
          influenceSources: ['Market Data', 'Analysis Tools'],
          socialProofSensitivity: 40,
          authorityBias: 50,
          communityEngagement: 50,
          opinionLeadership: 55,
          contrarian: 60
        },
        adaptability: {
          marketConditionAdaptation: 70,
          strategyFlexibility: 65,
          learningFromMistakes: 80,
          changeAcceptance: 70,
          innovationOpenness: 65,
          feedbackReceptivity: 75,
          stressResilience: 70
        },
        confidenceLevel: 75,
      ...
      mockProfiles.push(targetProfile);
    ...
    // Combine target wallet profile with default profiles
    mockProfiles = [...mockProfiles, ...defaultProfiles];
