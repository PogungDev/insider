...
export function FlowPatternDetector() {
  ...
  const mockPatterns: FlowPattern[] = [
    {
      id: "1",
      type: "accumulation",
      confidence: 87,
  ...
  const mockCrossChainFlows: CrossChainFlow[] = [
    {
      id: "1",
      fromChain: "Ethereum",
      toChain: "SEI",
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">AI-powered detection pola pergerakan capital dan trading behavior</p>
        </div>
