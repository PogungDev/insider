  ...
  const mockModels: PredictionModel[] = [
    {
      ...
      predictions: 1247,
      successRate: 85.2,
      description: 'Deep learning model untuk prediksi harga menggunakan LSTM'
    },
    {
      id: 'behavior_rf',
      ...
      predictions: 892,
      successRate: 79.8,
      description: 'Model ensemble untuk prediksi perilaku trading'
    },
    {
      id: 'risk_svm',
      ...
      predictions: 2156,
      successRate: 89.7,
      description: 'Support Vector Machine untuk analisis risiko'
    },
    {
      id: 'sentiment_bert',
      ...
      predictions: 3421,
      successRate: 87.4,
      description: 'Transformer model untuk analisis sentiment real-time'
    }
  ]
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">AI models untuk prediksi harga, perilaku, dan risiko</p>
        </div>
