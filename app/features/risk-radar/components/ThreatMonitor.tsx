...
export function ThreatMonitor() {
  ...
  useEffect(() => {
    ...
    setLiveThreats(mockLiveThreats)
    setAlertCount(mockThreats.filter(t => t.status === 'active').length)
  }, [])
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Real-time security monitoring dan early warning system</p>
        </div>
        ...
        <TabsContent value="live-monitoring" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Real-time monitoring dari blockchain events</CardDescription>
            </CardHeader>
            <CardContent>
